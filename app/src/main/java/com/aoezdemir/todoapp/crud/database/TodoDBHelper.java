...
public class TodoDBHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_TODO_LANG = "LANG";
    public static final String COL_TODO_LAT = "LAT";

    private static final String DATABASE_NAME = "Todos.db";
    private static final String TABLE_TODOS_NAME = "TODOS";
    private static final String QUERY_CREATE_TODOS = "create table " + TABLE_TODOS_NAME + "(" + COL_TODO_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " + COL_TODO_NAME + " TEXT NOT NULL, " + COL_TODO_DESCRIPTION + " TEXT, " + COL_TODO_EXPIRY + " INTEGER NOT NULL, " + COL_TODO_DONE + " INTEGER NOT NULL, " + COL_TODO_FAVOURITE + " INTEGER NOT NULL, " + COL_TODO_CONTACTS + " TEXT , " + COL_TODO_IMAGES + " BLOB," + COL_TODO_PRICE + " TEXT, " +  COL_TODO_LANG + " Double, " + COL_TODO_LAT + " Double " +")";
